...
export const PHYSICS_CATEGORIES = {
  classical_mechanics: [
    ...
    "dynamics_and_forces",
    "rotational_motion",
    "oscillations_and_vibrations",
    "elastic_and_collision",
  ],
  thermodynamics: [
  ...
  optics: [
    ...
    "polarization",
    "optical_instruments",
    "laser_and_modern_optics",
  ],
  fluid_mechanics: [
    "fluid_statics",
    "fluid_dynamics",
    "viscosity_and_turbulence",
    "surface_tension",
    "aerodynamics",
  ],
  modern_physics: [
  ...
  biophysics: [
    ...
    "membrane_physics",
    "molecular_motors",
    "biophysical_modeling",
  ],
  applied_and_engineering_physics: [
  ...
  everyday_and_phenomenon_physics: [
    "kitchen_physics",
    "sports_physics",
    "weather_and_climate",
    "transportation",
