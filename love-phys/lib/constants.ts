...
export const PHYSICS_CATEGORIES = {
  mechanics: ["motion", "forces", "gravity", "momentum", "energy"],
  ...
  light_and_optics: ["reflection", "refraction", "colors", "vision", "lasers"],
  fluids: ["water_physics", "air_pressure", "floating", "flying", "weather"],
  space_and_astronomy: [
    "planets",
    "stars",
    "gravity_in_space",
